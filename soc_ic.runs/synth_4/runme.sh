...
HD_PWD='C:/Users/cao2/Desktop/soci/soci/soc_ic/soc_ic.runs/synth_4'
cd "$HD_PWD"
...
EAStep vivado -log monitor_customized.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source monitor_customized.tcl
